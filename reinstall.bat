...
echo • Tworzę katalog instalacyjny "%INSTALL_DIR%"…
...
if not exist "%EXE_PATH%" (
    echo ✗ Błąd: plik nie został pobrany.  Kończę.
    goto :EOF
)
...
if %errorlevel%==0 (echo ✓ Usługa uruchomiona pomyślnie.) else (echo ✗ Nie udało się uruchomić!)
